  ...
  var defaults = {
    ...
    widget: {
      ...
      wrapperYear: {
        use: true,
        tag: 'div',
        class: 'col-sm-4 dropdown-year'
      },
      wrapperMonth: {
        use: true,
        tag: 'div',
        class: 'col-sm-5 dropdown-month'
      },
      wrapperDay: {
        use: true,
        tag: 'div',
        class: 'col-sm-3  dropdown-day'
      },
      selectYear: {
        name: 'birthday[year]',
        class: 'form-control'
  ...
  $.fn.bootstrapBirthday = function (options) {
    ...
    var createHtmlWidget = function () {
      ...
      bsBD.$wrapper.change(function () {
        ...
        if ((selectedYear * selectedMonth * selectedDay) != 0) {
          ...
          var hiddenDate = selectedYear + "-" + selectedMonth + "-" + selectedDay + " 00:00:00";
    ...
    var setDefaultValue = function () {
      ...
      if (value != "") {
        ...
        bsBD.$year.val(dP[0]*1);
        bsBD.$month.val([dP[1]*1]);
        bsBD.$day.val(dP[2]*1);
